...
const pages = ['Insert', 'Pricing', 'Blog','contact'];
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
                ...
                <MenuItem onClick={handleCloseNavMenu}>
                  <Typography textAlign="center"><Link to="/Insert">Insert</Link></Typography>
                </MenuItem>
                <MenuItem onClick={handleCloseNavMenu}>
                  <Typography textAlign="center"><Link to="/View">View</Link></Typography>
                </MenuItem>
                </Menu>
          </Box>
