...
useEffect(()=>{
  Axios.get(`http://localhost:8000/employe/singleview/${user}`)
.then((res)=>{
  ...
  return (
    <Card sx={ style}>
      ...
      <CardHeader
        ...
        title={
            <p style={{ fontWeight:'bolder', fontSize:"20px"}}> {state.userName}</p>
        }
        action={
      ...
      <CardContent>
        <Typography variant="body2" color="text.secondary">
          This impressive paella is.........  {state._id}......... a perfect party dish and a fun meal to cook
